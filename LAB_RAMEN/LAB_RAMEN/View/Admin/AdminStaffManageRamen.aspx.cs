...
{
    public partial class AdminStaffManageRamen : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("AdminStaffInsertRamen.aspx");
        ...
        protected void gridviewRamen_RowEditing(object sender, GridViewEditEventArgs e)
        {
            ...
            int id = Convert.ToInt32(row.Cells[0].Text);
            Response.Redirect("AdminStaffUpdateRamen.aspx?ID=" + id);
        }
    }
}