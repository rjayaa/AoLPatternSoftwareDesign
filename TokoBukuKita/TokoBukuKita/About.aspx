<%@ Page Title="About" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="About.aspx.cs" Inherits="TokoBukuKita.About" %>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <asp:TextBox ID="txtCustomer" CssClass="form-control" placeholder="Name" runat="server" />
                        <label>Name</label>
